...
def main():
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5, model_complexity=1) as pose:
        for traj_id in range(total_trajs_num):
            ...
            robot_agent.say('Going to start trial {}'.format(traj_id + 1))
            ...
            robot_agent.say('Great! This trial is finished')
            robot_agent.go_home_pose()

    print("All trajectories are recorded")
    ...
    print("All trajectories are saved")
    robot_agent.say("All trajectories are recorded and saved")
    robot_agent.stop()
    cap.release()
